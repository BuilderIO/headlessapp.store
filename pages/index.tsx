  ...
  return (
    <Link href="/components/101">
      <a className="p-8 bg-gray-600 rounded relative shadow group overflow-hidden md:py-16 text-center transition duration-150 ease-in-out">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-700 opacity-0 group-hover:opacity-50 w-full h-full transform transition duration-100 ease-in-out z-10"></div>
      </a>
    </Link>
  );
};
    ...
    <Layout title="Home | Next.js + TypeScript Example">
      <div className="p-6 py-12 md:py-32 lg:py-36 bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl sm:text-5xl md:text-6xl tracking-tight font-extrabold leading-tight text-transparent bg-gradient-to-r from-teal-500 via-blue-600 to-purple-800 bg-clip-text">
            Headless App Store
          </h2>
